...
export class AmiibosComponent implements OnInit {
  ...
  setPage( page: number ) {
    ...
    this.pager = this.paginationService.getPager(this.amiibos.length, page); // this line here is calling our information in the service instead of having all the logic here in this file the service does all the work in the background (make sure that you write the service first!)
